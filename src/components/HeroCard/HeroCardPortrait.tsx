...
const HeroCardPortraitComponent = ({ name, portrait, className }: HeroPortraitProps) => {
...
export const HeroCardPortrait = memo(HeroCardPortraitComponent, (prevProps, nextProps) => {
